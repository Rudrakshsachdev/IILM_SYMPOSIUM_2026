  ...
  const timelineData = [
    {
      ...
      desc: "Scientific abstract deadline",
      side: "left",
    },
    {
      id: "02",
    ...
    <section className={styles.timelineSection} id="dates" ref={sectionRef}>
      ...
      <div className={styles.container}>
        <div className={styles.header}>
          <p className={`${styles.eyebrow} ${isVisible ? styles.animate : ""}`}>
            Roadmap
          </p>
