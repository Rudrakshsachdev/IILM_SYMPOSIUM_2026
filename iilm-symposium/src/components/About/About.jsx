        ...
        <section className={styles.about} id="about" ref={sectionRef}>
            ...
            <div className={styles.container}>
                <div className={styles.contentGrid}>
                    ...
                    <div className={`${styles.visualContent} ${isVisible ? styles.animate : ""}`}>
                    ...
                    <div className={styles.textContent}>
                        <span className={`${styles.eyebrow} ${isVisible ? styles.animate : ""}`}>
                        ...
                        <div className={`${styles.descriptionWrapper} ${isVisible ? styles.animate : ""}`}>
                            <p className={styles.description}>
                                The International Symposium 2026 brings together the brightest minds
                                from academia and industry. A dedicated platform for
                                <strong> transformational research</strong> and sustainable solutions.
                            </p>
                        ...
                        <div className={`${styles.stats} ${isVisible ? styles.animate : ""}`}>
                ...
                <div className={styles.highlights}>
                    {[
                        { icon: "🌍", badge: "Global", title: "Collaboration", text: "Fostering international research participation and global academic synergy." },
                        { icon: "📚", badge: "Academic", title: "Excellence", text: "Peer-reviewed paper presentations and high-impact academic discussions." },
                        { icon: "🤝", badge: "Strategic", title: "Networking", text: "Bridging the gap between industry needs and academic research excellence." }
                    ].map((item, index) => (
                        <div
                            key={index}
